                        ...
                        <form class="form-horizontal form-submit-event" action="<?= base_url('admin/sellers/add_seller'); ?>" method="POST" id="add_product_form">
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="number" max="100" min="0" class="form-control" id="global_commission" placeholder="Enter Commission(%) to be given to the Super Admin on order item." name="global_commission" value="<?= @$fetched_data[0]['commission'] ?>">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <?php
                                    ...
                                    <?php if ((isset($shipping_method['pincode_wise_deliverability']) && $shipping_method['pincode_wise_deliverability'] == 1) || (isset($shipping_method['local_shipping_method']) && isset($shipping_method['shiprocket_shipping_method']) && $shipping_method['local_shipping_method'] == 1 && $shipping_method['shiprocket_shipping_method'] == 1)) { ?>
                                        ...
                                        <div class="form-group col-sm-10">
                                            <select class="form-control" name="deliverable_zipcode_type" id="deliverable_zipcode_type">
                                                <option value="<?= ALL ?>" <?= (isset($fetched_data[0]['deliverable_zipcode_type']) && $fetched_data[0]['deliverable_zipcode_type'] == 1) ? 'selected' : ''; ?>>All</option>
                                                <option value="<?= EXCLUDED ?>" <?= (isset($fetched_data[0]['deliverable_zipcode_type']) && $fetched_data[0]['deliverable_zipcode_type'] == 2) ? 'selected' : ''; ?>>Excluded</option>
                                            </select>
                                        </div>
                                    ...
                                    if (isset($shipping_method['city_wise_deliverability']) && $shipping_method['city_wise_deliverability'] == 1 && $shipping_method['shiprocket_shipping_method'] != 1) { ?>
                                        ...
                                        <div class="form-group col-sm-10">
                                            <select class="form-control" name="deliverable_city_type" id="deliverable_city_type">
                                                <option value="<?= ALL ?>" <?= (isset($fetched_data[0]['deliverable_city_type']) && $fetched_data[0]['deliverable_city_type'] == 1) ? 'selected' : ''; ?>>All</option>
                                                <option value="<?= EXCLUDED ?>" <?= (isset($fetched_data[0]['deliverable_city_type']) && $fetched_data[0]['deliverable_city_type'] == 2) ? 'selected' : ''; ?>>Excluded</option>
                                            </select>
                                        </div>
                                    <?php } ?>
                                </div>
                                <div class="form-group row">
                                    <?php if ((isset($shipping_method['pincode_wise_deliverability']) && $shipping_method['pincode_wise_deliverability'] == 1) || (isset($shipping_method['local_shipping_method']) && isset($shipping_method['shiprocket_shipping_method']) && $shipping_method['local_shipping_method'] == 1 && $shipping_method['shiprocket_shipping_method'] == 1)) { ?>
                                        ...
                                        <div class="col-sm-10">
                                            ...
                                            ?>
                                            <select name="serviceable_zipcodes[]" class="search_zipcode form-control w-100" multiple onload="multiselect()" id="deliverable_zipcodes" <?= (isset($fetched_data[0]['deliverable_zipcode_type']) && ($fetched_data[0]['deliverable_zipcode_type'] == INCLUDED || $fetched_data[0]['deliverable_zipcode_type'] == EXCLUDED)) ? "" : "disabled" ?>>
                                    ...
                                    if (isset($shipping_method['city_wise_deliverability']) && $shipping_method['city_wise_deliverability'] == 1 && $shipping_method['shiprocket_shipping_method'] != 1) { ?>
                                        ...
                                        <div class="col-sm-10">
                                            ...
                                            <select class="form-control city_list" name="serviceable_cities[]" id="deliverable_cities" multiple <?= (isset($fetched_data[0]['deliverable_city_type']) && ($fetched_data[0]['deliverable_city_type'] == INCLUDED || $fetched_data[0]['delideliverable_city_typeverable_zipcode_type'] == EXCLUDED)) ? "" : "disabled" ?>>
