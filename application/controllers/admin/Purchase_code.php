    ...
    public function validator()
    {
        if ($this->ion_auth->logged_in() && $this->ion_auth->is_admin()) {
            if ((isset($_POST['app_purchase_code']) && !empty($_POST['app_purchase_code'])) || (isset($_POST['web_purchase_code']) && !empty($_POST['web_purchase_code']))) {
                ...
                $app_url = base64_decode("aHR0cHM6Ly93cnRlYW0uaW4vdmFsaWRhdG9yL2hvbWUvdmFsaWRhdG9yX25ldz9wdXJjaGFzZV9jb2RlPQ==")."$purchase_code&domain_url=" . base_url() . "&item_id=" . APP_CODE;
                ...
                $web_url = base64_decode("aHR0cHM6Ly93cnRlYW0uaW4vdmFsaWRhdG9yL2hvbWUvdmFsaWRhdG9yX25ldz9wdXJjaGFzZV9jb2RlPQ==")."$purchase_code&domain_url=" . base_url() . "&item_id=" . WEB_CODE;
