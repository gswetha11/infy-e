    ...
    public function add_promo_code()
    {
        if ($this->ion_auth->logged_in() && $this->ion_auth->is_admin()) {
            ...
            if (!$this->form_validation->run()) {
                ...
                $fields = [ 'edit_promo_code', 'promo_code', 'message', 'start_date', 'end_date', 'no_of_users', 
                'minimum_order_amount','discount','discount_type', 'max_discount_amount', 'repeat_usage', 'image', 'status', 'no_of_repeat_usage', 'list_promocode', 'is_cashback'];
